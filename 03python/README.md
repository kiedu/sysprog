...
**Класи** використовуються для створення складних користувацьких структур даних. Також класи містять функції, які називаються **методами**, що визначають поведінку та дії, які **об'єкт** (частина коду і даних), створений з класу, може виконувати зі своїми даними.

![image](img/oop1.png)


### Поняття основних термінів
* Клас - шаблон, форма.
* Метод - визначена можливість або функція класу.
* Атрибут (поле) - фрагмент даних у класі.
* Екземпляр (instance)  - об'єкт класу.
* Конструктор - метод, що встановлює певні початкові значення при створенні об'єкту.
* Деструктор - метод, що видаляє об'єкт і його дані.
